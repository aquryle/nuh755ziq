...
volatile uint8_t b1state = 0;    // B1を押されたらインクリメント
/* USER CODE END PV */
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOF, TFT_DC_Pin|SD_CS_Pin|TFT_BL_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : TFT_DC_Pin SD_CS_Pin TFT_BL_Pin */
  GPIO_InitStruct.Pin = TFT_DC_Pin|SD_CS_Pin|TFT_BL_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
